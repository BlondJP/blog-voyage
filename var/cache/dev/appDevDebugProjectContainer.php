...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.postrepository' => 'getApp_PostrepositoryService',
            'app.postservice' => 'getApp_PostserviceService',
    ...
    /**
     * Gets the 'app.postrepository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getApp_PostrepositoryService()
    {
        return $this->services['app.postrepository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\Post');
    }

    /**
     * Gets the 'app.postservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\PostService A AppBundle\Service\PostService instance
     */
    protected function getApp_PostserviceService()
    {
        return $this->services['app.postservice'] = new \AppBundle\Service\PostService($this->get('doctrine.orm.default_entity_manager'), $this->get('app.postrepository'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('24SRuaYTRy', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KUaZ0D-sga', 0, 'zoJX3bGrp-4fMyxkrHsPOP', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'blog-voyage', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_918f264071cf603b6f34c9adc7f63dd7380471633c28202be839df485b37c579');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f08ab2aafa8ec79365156be269dffa29cb6059a0');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6q50+3MeMa', 0, 'zoJX3bGrp-4fMyxkrHsPOP', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('591b73df07dda9.62469956')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'f08ab2aafa8ec79365156be269dffa29cb6059a0',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'f08ab2aafa8ec79365156be269dffa29cb6059a0',
